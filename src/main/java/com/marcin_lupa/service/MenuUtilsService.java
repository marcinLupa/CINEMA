...
import com.marcin_lupa.json.impl.MapConverter;
...
import com.marcin_lupa.model.utils.Ticket;
...
import static com.marcin_lupa.exceptions.ExceptionCode.*;
...
class MenuUtilsService {
    ...
    void managingTickets() {
        ...
        final String SEANCES_FILENAME = "src/main/resources/files/seances/LISTOFSEANCES.json";
