package com.marcin_lupa.repository.impl;

import com.marcin_lupa.connection.DbConnection;
import com.marcin_lupa.exceptions.ExceptionCode;
import com.marcin_lupa.exceptions.MyException;
import com.marcin_lupa.json.impl.MovieConverter;
import com.marcin_lupa.model.Movie;
import com.marcin_lupa.repository.CrudRepository;
import com.marcin_lupa.model.utils.SortingOptions;
...
public class MovieRepository implements CrudRepository<Movie, Integer> {
    ...
    public void addFilmFromFile(String filename) {
        try {
            ...
            final String FILE_FOLDER = "src/main/resources/files/movies/";
